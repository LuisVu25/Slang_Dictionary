...
public class quiz extends Thread implements ActionListener {
    ...
    int score = 0;
    JButton a, b, c, d;
    JLabel question, statement, scorelabel, cooldown;
    SlangDictionary dict;

    int t = 100;
    boolean bonus;

    public quiz(int GameMode,
                JButton a, JButton b, JButton c, JButton d,
                JLabel question, JLabel statement, JLabel cooldown, JLabel scorelabel,
                SlangDictionary dict) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (chosenAnswer == correctAnswer) {
                ...
                /*
                BẠN ĐÃ TRẢ LỜI SAI VÀ KẾT THÚC CHO ĐIỂM.
                * */
